...
public class CustomerValueEntityHandler implements ValueEntityHandler {
  ...
  @Override
  public Reply<Any> handleCommand(Any command, CommandContext<Any> context) throws Throwable {
    ...
    switch (context.commandName()) {
      case "Create":
        return entity.create(
            ...
            CustomerApi.Customer.parseFrom(command.getValue()), context.getState(), context);
      case "ChangeName":
